...
p1 <- supp_orig$heatmap + ggtitle("Suppression Heatmap – Original Data", subtitle = plot_title)  + theme(axis.title.x = element_blank(), legend.position = "none")
p2 <- supp_inf$heatmap + ggtitle("Suppression Heatmap – Inferred Data", subtitle = plot_title) + theme(axis.title.x   = element_blank(), legend.position = "none") 
...
plot_reg_5yr <- make_suppression_plot(
  ...
  time_var     = "Month.Code",
  plot_title   = "Census Region – 5-Year Age Groups"
)
