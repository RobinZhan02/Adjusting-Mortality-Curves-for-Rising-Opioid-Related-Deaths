...
```{r warning=FALSE}
census_region <- read.csv("../data/eda/WONDER-Census Region.csv") %>%
  filter(Year != "NA")
...
```{r warning=FALSE}
census_division <- read.csv("../data/eda/WONDER-Census Division.csv") %>%
  filter(Year != "NA")
...
```{r warning=FALSE}
sex <- read.csv("../data/eda/WONDER-Sex.csv") %>%
  filter(Year != "NA")
...
ten_year <- read.csv("../data/eda/WONDER-10YrAge.csv") %>%
...
five_year <- read.csv("../data/eda/WONDER-5YrAge.csv") %>%
...
```{r}
dataset_1 <- read.csv("../data/missing data/WONDER-SEX-5Yr-Cenus Division.csv")

analyze_suppression(dataset_1, "Sex", "Five.Year.Age.Groups", "Census.Division", "Month.Code")
```

```{r}
dataset_2 <- read.csv("../data/missing data/WONDER-SEX-5Yr-Cenus Region.csv")

analyze_suppression(dataset_2, "Sex", "Five.Year.Age.Groups", "Census.Region", "Month.Code")
```

```{r}
dataset_3 <- read.csv("../data/missing data/WONDER-SEX-10Yr-Cenus Division.csv")

analyze_suppression(dataset_3, "Sex", "Ten.Year.Age.Groups", "Census.Division", "Month.Code")
```

```{r}
dataset_4 <- read.csv("../data/missing data/WONDER-SEX-10Yr-Cenus Region.csv")
