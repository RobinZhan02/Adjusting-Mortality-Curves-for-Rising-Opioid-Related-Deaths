...
p1 <- supp_orig$heatmap + ggtitle("Suppression Heatmap – Original Data")  + theme(axis.title.x = element_blank(), legend.position = "none")
p2 <- supp_inf$heatmap + ggtitle("Suppression Heatmap – Inferred Data") + theme(axis.title.x   = element_blank(), legend.position = "none") 
