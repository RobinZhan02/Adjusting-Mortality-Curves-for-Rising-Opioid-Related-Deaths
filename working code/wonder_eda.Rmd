...
analyze_suppression <- function(data,
  ...
  scale_fill_gradientn(
    colors = c("#004c99", "#007acc","#26b4f0", "#80e0ff", "#e0faff"),
    limits = c(0, 100),
    name = "% Suppressed",
    breaks = seq(0, 100, 25),
...
```{r}
dataset_1 <- read.csv("../data/missing_data/data_for_infer/WONDER-Sex-10Yr-Census-Region-Clean.csv")

analyze_suppression(dataset_1, "Sex", "Ten.Year.Age.Groups", "Census.Region", "Month.Code")
