...
```{r warning=FALSE}
census_region <- read.csv("~/Adjusting-Mortality-Curves-for-Rising-Opioid-Related-Deaths/data/eda/WONDER-Census Region.csv") %>%
  filter(Year != "NA")
...
```{r warning=FALSE}
census_division <- read.csv("~/Adjusting-Mortality-Curves-for-Rising-Opioid-Related-Deaths/data/eda/WONDER-Census Division.csv") %>%
  filter(Year != "NA")
...
```{r warning=FALSE}
sex <- read.csv("~/Adjusting-Mortality-Curves-for-Rising-Opioid-Related-Deaths/data/eda/WONDER-Sex.csv") %>%
  filter(Year != "NA")
...
ten_year <- read.csv("~/Adjusting-Mortality-Curves-for-Rising-Opioid-Related-Deaths/data/eda/WONDER-10YrAge.csv") %>%
...
five_year <- read.csv("~/Adjusting-Mortality-Curves-for-Rising-Opioid-Related-Deaths/data/eda/WONDER-5YrAge.csv") %>%
