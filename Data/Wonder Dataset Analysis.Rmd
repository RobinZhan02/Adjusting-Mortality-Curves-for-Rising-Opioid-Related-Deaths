...
```{r}
dataset_3 <- read.csv("~/Adjusting-Mortality-Curves-for-Rising-Opioid-Related-Deaths/Data/WONDER-SEX-5Yr-State.csv")

analyze_suppression(dataset_3, "Sex", "Five.Year.Age.Groups", "State", "Month.Code")
```

```{r}
dataset_4 <- read.csv("~/Adjusting-Mortality-Curves-for-Rising-Opioid-Related-Deaths/Data/WONDER-SEX-10Yr-Cenus Division.csv")

analyze_suppression(dataset_4, "Sex", "Ten.Year.Age.Groups", "Census.Division", "Month.Code")
```